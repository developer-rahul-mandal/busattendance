...
<head>
    ...
    <title>মহিলা পরিচারিকা যোগ করুন - বাস উপস্থিতি ব্যবস্থাপনা</title>
            ...
            <div class="col-md-8">
                <div class="form-container">
                    <div class="form-header">
                        ...
                        <h3>নতুন মহিলা পরিচারিকা যোগ করুন</h3>
                        <p>মহিলা পরিচারিকার তথ্য প্রবেশ করে নতুন মহিলা পরিচারিকা সিস্টেমে যোগ করুন</p>
                    </div>
                    ...
                    <form action="process_add_attendant.php" method="POST">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="attendant_name" class="form-label">মহিলা পরিচারিকা নাম <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="attendant_id_number" name="attendant_id_number" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="experience_years" class="form-label">মহিলা পরিচারিকা অভিজ্ঞতা (বছর)</label>
                        ...
                        <div class="mb-3">
                            <label for="address" class="form-label">মহিলা পরিচারিকা ঠিকানা</label>
                            <textarea class="form-control" id="address" name="address" rows="3" placeholder="মহিলা পরিচারিকার পূর্ণ ঠিকানা..."></textarea>
                        </div>
